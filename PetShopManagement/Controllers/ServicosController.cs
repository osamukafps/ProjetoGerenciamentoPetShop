...
namespace PetShopManagement.Controllers
{
    public class ServicosController : Controller
    {
        ...
        public ServicosController(PetShopManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Valor")] Servicos servicos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Valor")] Servicos servicos)
        {
            if (id != servicos.Id)
            {
                return NotFound();
